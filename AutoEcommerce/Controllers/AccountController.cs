using AutoEcommerce.Dtos;
using AutoEcommerce.Extensions;
using Core.Entity;
...
namespace AutoEcommerce.Controllers
{
    ...
    {
        [HttpPost("register")]
        public async Task<ActionResult<AppUser>> Register([FromBody] RegisterDto model)
        {
        ...
        public async Task<ActionResult<Address>> CreateOrUpdateAddress([FromBody] AddressDto addressDto)
        {
            ...
            if(!result.Succeeded)
            {
                return BadRequest("Proplem Updating Address");
            }
